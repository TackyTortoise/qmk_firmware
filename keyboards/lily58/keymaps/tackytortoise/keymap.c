...
[_LOWER] = LAYOUT(
  ...
  KC_LCTL, _______, _______, KC_LCBR, KC_RCBR, KC_RBRC,  _______, _______, KC_AT  , KC_HASH, KC_GRV, _______, KC_BSLS, _______,
 ...
 * |------+------+------+------+------+------|                    |------+------+------+------+------+------|
 * |      |      |      |  7   |   8  |   9  |                    |      | Home |  Up  | End  |      | F12  |
 * |------+------+------+------+------+------|                    |------+------+------+------+------+------|
 * | Shift|      |      |  4   |   5  |   6  |-------.    ,-------|      | Left | Down |Right |      |      |
 * |------+------+------+------+------+------|       |    |       |------+------+------+------+------+------|
 * | CTRL |      |      |  1   |   2  |   3  |-------|    |-------|   +  |   -  |   =  |   [  |   ]  |   \  |
 * `-----------------------------------------/       /     \      \-----------------------------------------'
...
[_RAISE] = LAYOUT(
  ...
  KC_LCTL, _______,  _______,   KC_1,   KC_2,   KC_3,    KC_0, _______,  KC_PLUS, KC_MINS, KC_EQL,  KC_LBRC, KC_RBRC, KC_BSLS,
