...
[_LOWER] = LAYOUT(
  ...
  KC_LSFT, _______, _______, KC_LPRN, KC_RPRN, KC_LBRC ,                   KC_CIRC, KC_PLUS, KC_EQL, KC_MINS, KC_ASTR, KC_TILD,
  KC_LCTL, _______, _______, KC_LCBR, KC_RCBR, KC_RBRC,  _______, _______, XXXXXXX, KC_HASH, KC_GRV, _______, KC_BSLS, KC_PIPE,
